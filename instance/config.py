...
###微信公众平台回复消息#############################################################
SUBSCRIBE_RESPONSE_TEXT = u"你好，欢迎关注股星公众号，你可以点击菜单查看下个交易日股星推荐的股票，" \
                          u"也可以通过聊天窗口回复股票代码获取下个交易日股票涨跌信息，如回复股票代码：" \
                          u"000001，将收到系统回复\"你好，你关注的股票000001(平安银行)，下个交易日呈现上涨(下跌)趋势。\""
